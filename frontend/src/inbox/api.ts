...
export type NotificationKind = 'reply' | 'mention' | 'team_mention' | 'new_chapters' | 'suggestions_reviewed';
...
export type NotificationPayload = {
    ...
    commentId?: number; first?: number; last?: number; accepted?: number; rejected?: number;
};
