...
Цільову оцінку всієї глави задає `NOVELKA_TARGET_USD_PER_5000` (типово `0.10` за
5000 source-токенів). Зміна цього параметра не змінює фактичні витрати й уже
записані метрики попередніх jobs.
