...
- Розмір тексту 16–28 px і спільна для всього сайту тема: світла, темна або чорна
  ...
  через ThemeContext. Палітра задається CSS-змінними, колір панелі браузера — theme-color.
